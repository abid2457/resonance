            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="video-container" id="videoWrapper">
                        <img id="thumbnail" src="/assets/images/zamna1.jpg" alt="Thumbnail">
                        <div class="play-icon" id="playButton">▶</div>
                    </div>
                    
                    <video id="videoPlayer" controls src="/assets/images/Zamna Festival 2025.mp4" style="display: none;"
                        width="700"></video>
                </div>
                <div class="col-lg-4">
                    <div class="right-content">
                        <h4>Zamna India | Mumbai</h4>
                        <span id="tickets-remaining">500 Tickets still available</span>
                        <ul>
                            <li><i class="fa fa-clock-o"></i> March 29 | 6PM onwards</li>
                            <li><i class="fa fa-map-marker"></i>Venue to be announced, Mumbai</li>
                        </ul>
                        <div class="quantity-content">
                            <div class="left-content">
                                <h6>Standard Ticket</h6>
                                <p id="ticket-price" data-price="699">₹699 per ticket</p>
                            </div>
                            <div class="right-content">
                        ...
                        <div class="total">
                            <h4>Total: <span id="total-price">₹699</span></h4>
