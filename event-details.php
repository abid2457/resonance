...
$total_query = $conn->query("SELECT COUNT(*) AS total FROM events WHERE date_time >= NOW()");
...
$query = $conn->query("SELECT * FROM events WHERE date_time >= NOW() ORDER BY date_time ASC LIMIT $start_from, $results_per_page");
...
<html lang="en">
  ...
  <head>
    ...
    <title>Resonance - Event Detail Page</title>
