            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="left-image">
                        <img src="/assets/images/deva.jpg" alt="">
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="right-content">
                        <h4>Prabhu Deva's Vibe Live - In Dance Concert</h4>
                        <span id="tickets-remaining">500 Tickets still available</span>
                        <ul>
                            <li><i class="fa fa-clock-o"></i> February 22 | 6PM</li>
                            <li><i class="fa fa-map-marker"></i>YMCA Ground, Nandanam, Chennai</li>
                        </ul>
                        <div class="quantity-content">
                            <div class="left-content">
                                <h6>Standard Ticket</h6>
                                <p id="ticket-price" data-price="999">₹999 onwards per ticket</p>
                            </div>
                            <div class="right-content">
                        ...
                        <div class="total">
                            <h4>Total: <span id="total-price">₹999.00</span></h4>
